...
test-add1.mc test-addf1.mc test-arith1.mc test-arith2.mc test-arith3.mc test-fib.mc test-for1.mc \
test-for2.mc test-func1.mc test-func2.mc test-func3.mc test-func4.mc test-func5.mc \
test-func6.mc test-func7.mc test-func8.mc test-func9.mc test-func10.mc test-gcd2.mc test-gcd.mc test-global1.mc test-global2.mc test-global3.mc test-global4.mc test-hello.mc \
...
test-var1.mc test-var2.mc test-while1.mc test-while2.mc test-dowhile1.mc test-ex1.mc test-ex2.mc test-ex3.mc test-ex4.mc test-ex5.mc test-ex6.mc test-ex8.mc test-ex9.mc test-ex10.mc test-ex11.mc test-ex11count.mc \
